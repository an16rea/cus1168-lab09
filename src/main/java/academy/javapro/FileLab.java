...
public class FileLab {
    ...
    private static void displayData(List<Map<String, String>> data) {
        ...
        for(Map<String,String> record : data){
            System.out.println(String.format("%-8s %-12s %-20s %-10s %-8s %-10s %-12s %-8s",
            record.get("OrderID"), record.get("Date"), record.get("CustomerName"), record.get("ProductID"), record.get("Quantity"),
            record.get("UnitPrice"), record.get("TotalAmount"), record.get("Region")));
        }
